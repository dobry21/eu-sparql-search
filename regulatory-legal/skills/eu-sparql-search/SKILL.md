...
argument-hint: "Describe what EU legislation or CJEU case law you are looking for (e.g. 'GDPR in Polish', 'directives on AI from 2024', 'CJEU judgments on data transfers')"
user-invocable: true
---
...
> **This skill requires outbound access to the following domains. Add them to your allowlist before use:**
>
> | Domain | Purpose |
> |---|---|
> | `publications.europa.eu` | SPARQL endpoint + Cellar file downloads |
> | `eur-lex.europa.eu` | Canonical citation links |
> | `eurovoc.europa.eu` | EuroVoc thesaurus (thematic search) |
>
> **Claude.ai / Claude Code:** In your project or session settings, add all three domains under *Network access* → *Allowed domains*.
> Without this, all SPARQL queries and document downloads will fail with a network error.
